       ...
       <ul className="flex flex-1 flex-col space-y-2 mt-6">
          ...
          <li>
             <div className="flex items-center">
                <span className="relative flex items-center justify-center text-indigo-100 hover:bg-[#101d30] h-12 w-12 rounded-2xl cursor-pointer" onClick={() => setShowDiscussionPane(true)}>
